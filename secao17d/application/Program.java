...
public class Program {
	...
	public static void printList(List<?> list) {
		/*
		 * We cannot add data to the list because we do not know what type the list is.
		 * It gives a compilation error.
		 * 
		 * Não podemos adicionar dados a lista, pois não sabemos de que tipo é a lista.
		 * Dar erro de compilação.
		 * 
